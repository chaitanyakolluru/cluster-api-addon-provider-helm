...
func (in *HelmChartProxySpec) DeepCopyInto(out *HelmChartProxySpec) {
	*out = *in
	...
	if in.InstallRolloutOptions != nil {
		in, out := &in.InstallRolloutOptions, &out.InstallRolloutOptions
		*out = new(RolloutOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.UpgradeRolloutOptions != nil {
		in, out := &in.UpgradeRolloutOptions, &out.UpgradeRolloutOptions
		*out = new(RolloutOptions)
		(*in).DeepCopyInto(*out)
	}
