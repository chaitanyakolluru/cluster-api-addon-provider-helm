...
func (in *HelmChartProxySpec) DeepCopyInto(out *HelmChartProxySpec) {
	*out = *in
	...
	if in.RollingReconciliation != nil {
		in, out := &in.RollingReconciliation, &out.RollingReconciliation
		*out = new(RollingReconciliation)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RollingReconciliation) DeepCopyInto(out *RollingReconciliation) {
	*out = *in
	if in.Step != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RollingReconciliation.
func (in *RollingReconciliation) DeepCopy() *RollingReconciliation {
	if in == nil {
		return nil
	}
	out := new(RollingReconciliation)
